...
<script>
    $(function() {
        ...
        $("#busNumbers").autocomplete({
            source: function(request, response) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . 'index.php/dashboard/busNoQuery'; ?>",
                    dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $('#searchbbutton').click(function() {
            ...
            if (valid == false) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . 'index.php/dashboard/selectSeatsDas' ?>",
                    data: {
                        'busNo': busNo,
                        'depDate': depDate},
                    success: function(msg)
                    {
                        ...
                        $('#select-seats-dashboard').html(msg);
                    }
...
<div id="right">
    ...
    <div style="width: 100%; float: left;">
        <div class="ui-widget" style="width: 25%; float: left;">
            <p><label for="from">Bus Number:</label><br/>
                <input class="textInput" placeholder="Bus Number" id="busNumbers" >
            </p>
        </div>
